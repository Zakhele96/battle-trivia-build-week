...
export default function RoomCard({ room }) {
  ...
  return (
    <div className="group h-full overflow-hidden rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.015))] shadow-[0_14px_30px_rgba(0,0,0,0.14)] transition-all duration-300 hover:-translate-y-[2px] hover:border-white/15 hover:bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))] sm:rounded-[24px] sm:shadow-[0_16px_36px_rgba(0,0,0,0.14)]">
      ...
      <div className="flex h-full flex-col p-3.5 sm:p-5">
        ...
        <div className="mt-3 min-w-0 sm:mt-4">
          <h3 className="truncate text-[16px] font-semibold tracking-[-0.03em] text-white sm:text-[18px]">
            {room?.name || "Room"}
          </h3>
        ...
        <div className="mt-4 flex items-center justify-between gap-3 border-t border-white/6 pt-3.5 sm:mt-5 sm:pt-4">
          ...
          <Link
            to={`/rooms/${room?.id}`}
            className="inline-flex items-center gap-2 rounded-[16px] border border-white/10 bg-white/[0.04] px-3.5 py-2.5 text-[13px] font-medium text-white transition-all duration-300 hover:border-white/15 hover:bg-white/[0.07] sm:rounded-[18px] sm:px-4 sm:text-sm"
          >
            {meta.cta}
